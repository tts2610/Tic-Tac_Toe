...
export default class App extends Component {
  ...
  checkRightDiagonal() {
    ...
    this.state.board.forEach((element) => {
      if (
        (element.id === [0, 2] && element.value === "x") ||
        (element.id === [1, 1] && element.value === "x") ||
        (element.id === [2, 0] && element.value === "x")
      ) {
        count++;
      }
    });
  ...
  checkLeftDiagonal() {
    ...
    this.state.board.forEach((element) => {
      if (
        (element.id === [0, 0] && element.value === "x") ||
        (element.id === [1, 1] && element.value === "x") ||
        (element.id === [2, 2] && element.value === "x")
      ) {
        count++;
      }
    });
