...
export default class App extends Component {
  ...
  checkDiagonal(currentChoice) {
    ...
    this.state.board.forEach((element) => {
      if (
        currentChoice.id[0] === element.id[0] + mySetting.boardWidth - 1 &&
        currentChoice.id[1] === element.id[1] - mySetting.boardWidth - 1 &&
        currentChoice.id[0] === element.id[0] + mySetting.boardWidth - 2 &&
        currentChoice.id[1] === element.id[1] - mySetting.boardWidth - 2 &&
        element.value === "x" &&
        currentChoice !== element
      ) {
        count++;
